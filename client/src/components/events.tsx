...
const columns: ColumnDef<z.infer<typeof schema>>[] = [
  ...
  },
  {
    ...
    header: "Group Name",
    cell: ({ row }) => (
      <div className="text-sm">{row.original.group_name || "No group"}</div>
    ),
  },
  {
    accessorKey: "date",
  ...
  {
    accessorKey: "venue_img_url",
    header: "Venue",
    cell: ({ row }) => (
      <div className="w-16 h-12 rounded overflow-hidden">
        <img
          src={row.original.venue_img_url}
          alt={row.original.name || "Event image"}
          className="w-full h-full object-cover"
          onError={(e) => {
            e.currentTarget.src = "/placeholder-event.jpg";
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      ...
                      selected event(s)? This action cannot be undone.
                    </DialogDescription>
                  </DialogHeader>
                  <DialogFooter>
                    <Button
    ...
    >
      ...
      <DrawerContent>
        <DrawerHeader className="gap-1">
          <DrawerTitle>
            Event Details - {item.name || item.event_id || item.public_id}
          </DrawerTitle>
        </DrawerHeader>
