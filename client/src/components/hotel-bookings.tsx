        ...
        <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-3">
              ...
              <Input id="application_id" defaultValue={item.application_id} disabled className="font-mono text-xs bg-muted" />
            </div>
            <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Input id="rooms" defaultValue={item.room_number.join(", ")} disabled className="bg-muted" />
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div className="flex flex-col gap-3">
                <Label htmlFor="total_rooms">Total Rooms</Label>
                <Input id="total_rooms" type="number" defaultValue={item.total_rooms} disabled className="bg-muted" />
              </div>
              <div className="flex flex-col gap-3">
                <Label htmlFor="total_people">Total Guests</Label>
