...
const columns: ColumnDef<z.infer<typeof schema>>[] = [
    ...
    },
    {
        ...
        header: "Time Slot",
        cell: ({ row }) => (
            <div className="text-sm font-medium">{row.original.time_slot}</div>
        ),
    },
    {
    ...
    const exportToExcel = () => {
        try {
            ...
            const exportData = data.map((item: TableDataType) => ({
                ...
                "Food Preference": item.food_preferences,
                "Table Status":
                    item.status.charAt(0).toUpperCase() + item.status.slice(1),
                "Total Amount (₹)": item.total_amount,
                "Payment Status": item.paid ? "Paid" : "Unpaid",
                "Created At": new Date(item.created_at).toLocaleString(),
                "Document URL": item.aadhar_or_pan_img_url,
            }));
            ...
            const filename = `food-court-bookings-${currentDate}.xlsx`;
        ...
        >
            ...
            <DrawerContent>
                <DrawerHeader className="gap-1">
                    <DrawerTitle>
                        Food Court Booking Details - {item.name}
                    </DrawerTitle>
                </DrawerHeader>
                <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="flex flex-col gap-3">
                                <Label htmlFor="total_people">
                                    Total People
                                </Label>
                                <Input
                                    id="total_people"
                                    type="number"
                                    defaultValue={item.total_people}
                                    disabled
                                    className="bg-muted"
                                />
                            </div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div className="flex flex-col gap-3">
                                ...
                                <Input
                                    id="food_preferences"
                                    defaultValue={item.food_preferences}
                                    disabled
                                    className="bg-muted"
                                />
                            </div>
