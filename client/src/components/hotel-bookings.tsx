...
const columns: ColumnDef<z.infer<typeof schema>>[] = [
    ...
    },
    {
        ...
        header: "Room Numbers",
        cell: ({ row }) => (
            <div className="text-sm">{row.original.room_number.join(", ")}</div>
        ),
    },
    {
        accessorKey: "email",
                ...
                <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex flex-col gap-3">
                            ...
                            <Input
                                id="application_id"
                                defaultValue={item.application_id}
                                disabled
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            <Input
                                id="rooms"
                                defaultValue={item.room_number.join(", ")}
                                disabled
                                className="bg-muted"
                            />
                        </div>
